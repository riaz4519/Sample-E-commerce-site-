...
<?php
	 if ($_SERVER["REQUEST_METHOD"] == "POST") {
	 	if (isset($_POST['cate']) && isset($_POST['comp']) && isset($_POST['sale'])  && isset($_POST['percent'])){
	 		...
	 		$query_input = "UPDATE product SET sale = '$sale',percent = '$percent' WHERE category = '$cate' AND company = '$comp'";
