...
?>
		...
		<h2 style="text-transform: uppercase;">PRODUCT ON <?php if($search){
			echo $search;
		}
		...
		<div class="container container-background">
		  ...
		  if (!isset($_GET['pagi'])) {
		      ...
		      $left = 0;
		  		...
		  		$query_feat = "SELECT * FROM product WHERE category LIKE '%".$search."%' or company LIke '%".$search."%' or title LIke '%".$search."%' or details LIke '%".$search."%' or image LIke '%".$search."%' or gender LIke '%".$search."%' LIMIT $left,$right";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<div class="container text-center">              
		  ...
		  <?php 
		  if(!isset($pass)){
		  $query_feat = "SELECT * FROM product WHERE category LIKE '%".$search."%' or company LIke '%".$search."%' or title LIke '%".$search."%' or details LIke '%".$search."%' or image LIke '%".$search."%' or gender LIke '%".$search."%'";
		  $result_feat = select_fun($query_feat);
		...
		if($rows_count>6){
		  $i = 1;
		   ...
		   ?>
		   <li><a href="search.php?pagi=<?php echo $pass?>&search=<?php echo $search; ?>"><?php echo $i; ?></a></li>
		   <?php
		   $i++;
		    } }?>
